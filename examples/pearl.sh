...
# Device settings
export DEVICE=8130
export DEVICE_OS=4.5.0
export DEVICE_PORT=25602
export DEVICE_PIN=553648140
...
export PYTHONSTARTUP="$PYTHON_TEST_ROOT/examples/pearlstartup.py"
